        ...
        <?PHP
            ...
            if ($_POST['_form_submit'] != 1) //in this case, the form has not been submitted, so show it
            {
                ...
                if ($errors) {
                    ...
                    $project = new Project($_POST['mm_dd_yy'], $_POST['address'], $_POST['name'], $_POST['start_time'],
                                           $_POST['end_time'], $_POST['dayOfWeek'], $_POST['vacancies'],
                ...
                // try to add a new project to the database
                    ...
                    if ($_POST['old_id'] == 'new') {
                        ...
                        if ($dup) {
                            ...
                            $newproject =
                                new Project($mm_dd_yy, $address, $name, $start_time, $end_time, $dayOfWeek, $vacancies,
                                            $persons, $id, $notes);
