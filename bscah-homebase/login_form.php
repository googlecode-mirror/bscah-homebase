...
<div id="content">
    ...
    //$_SESSION['access_level'] = 0; //set as a default until login
        ...
        if (!array_key_exists('_submit_check', $_POST)) {
            ...
            echo('(If you are having difficulty logging in or if you have forgotten your Password, please contact the <a href="mailto:volunters@bedstuyagainsthunger.org"><i>volunteer coordinator</i></a>.) ');
