            ...
            <div id="content">
                ...
                if ($person) {
                    ...
                    if ($_SESSION['access_level'] == 2) {
                        ...
                        //If $array_New_Volunteers has any new volunteers it will display their first and last name, else it will say there are no new volunteers.
                        echo('<div class="applicantsBox"><p><strong>New Volunteers (within a week):</strong><ul>');

                        if (empty($array_New_Volunteers)) {
                            echo('There are no new volunteers within the past week.');
                        } else {
                            //Old way of displaying applicants
                            /* $applicants_tab = getall_applicants();
                              $numLines = 0;
                              if (mysql_num_rows($array_New_Volunteers) > 0) {
                              echo('<div class="applicantsBox"><p><strong>Open Volunteer Applications:</strong><ul>');
                              while ($thisRow = mysql_fetch_array($array_New_Volunteers, MYSQL_ASSOC)) {
                            ...
                            foreach ($array_New_Volunteers as $temp_Volunteers) {
                                echo ("<tr><td><a href=personEdit.php?id=" . $temp_Volunteers->get_id() . ">" .
                                $temp_Volunteers->get_first_name() . ' ' .
                                $temp_Volunteers->get_last_name() .
                                "</td></a></tr>" );
                            }
                            echo('</table>');
                        }
