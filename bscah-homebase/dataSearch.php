...
<div id="content"><?php
    ...
    function process_form() {
        ...
        if ($_POST['_form_submit'] == 1) {
            ...
            $result =
                get_people_for_export("*", $_SESSION['first_name'], $_SESSION['last_name'], $_SESSION['gender'],
                                      $_SESSION['type'],
                                      $_SESSION['status'], $_SESSION['start_date'], $_SESSION['city'],
                                      $_SESSION['zip'],
            ...
            if ($_POST['_form_submit'] == 2) {
                    ...
                    if ($_POST['b_export']) {
                        ...
                        if ($_POST['results_list']) {
                            ...
                            foreach ($_POST['results_list'] as $export_person) {
                                ...
                                error_log("Exporting data for " . $temp_dude->get_first_name() . " " .
                                          $temp_dude->get_last_name());
                            }
                        }
                        include('dataExport.inc.php');
                    }
                ...
                if ($_POST['_form_submit'] == 3) {
                    ...
                    $result = get_people_for_export($all_attrs_concat, $_SESSION['first_name'],
                                                    $_SESSION['last_name'], $_SESSION['gender'],
                                                    $_SESSION['type'], $_SESSION['status'],
                                                    $_SESSION['start_date'], $_SESSION['city'],
    ...
    function export_data($current_time, $search_attr, $export_data) {
        ...
        foreach ($export_data as $person_data) {
            if (count($person_data) > 1 && $person_data[1] != ""
            ) // anything more than the id, export it, otherwise skip it
            {
