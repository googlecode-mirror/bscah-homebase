...
CREATE TABLE IF NOT EXISTS `person` (
  ...
  `Type` int(2) NOT NULL COMMENT 'Denotes wether a Coordinator or Volunteer',
...
('Alana2147483647', 'Alana', 'Mutum', '09/19/1993', 'F', '1140 Esther Street', 'Franklin Square', 'NY', '11010', 2147483647, NULL, 'lanixxjay@live.com', 2, 'Applicant', '', '', '0a56fdd1488f6102ecd18dead95ed83c', '', 'email');
