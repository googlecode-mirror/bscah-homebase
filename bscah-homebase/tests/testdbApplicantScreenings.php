<?php
    ...
    class testdbApplicantScreenings
        ...
        function testdbApplicantScreeningsModule() {
            ...
            $this->assertEqual(retrieve_dbApplicantScreenings($screening1->get_type())->get_creator(),
                               "Gabrielle1111234567")
            ;
            $this->assertEqual(retrieve_dbApplicantScreenings($screening1->get_type())->get_steps(),
                               ["complete application", "background check", "complete interview"])
            ;
