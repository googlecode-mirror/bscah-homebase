<?php
    ...
    class testMasterScheduleEntry
        ...
        function testMasterScheduleEntryModule() {
            ...
            $this->assertTrue($new_MasterScheduleEntry->get_persons() == ["joe2071234567", "sue2079876543"]);
